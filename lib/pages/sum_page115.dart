...
import 'package:accoola/service/models/resp115.dart';
...
class SumPage115 extends StatefulWidget {
  const SumPage115({Key key}) : super(key: key);

  @override
  _SumPageState createState() => _SumPageState();
}

class _SumPageState extends State<SumPage115> {
  Resp115 resp112 = Resp115();
              ...
              children: [
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    resp112 = Resp115.fromJson(jsonDecode(snapshot.data));
