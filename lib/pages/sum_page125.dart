...
class SumPage125 extends StatefulWidget {
  const SumPage125({Key key}) : super(key: key);

  @override
  _SumPageState createState() => _SumPageState();
}

class _SumPageState extends State<SumPage125> {
  Resp124 resp112 = Resp124();
              ...
              children: [
                FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    ...
                    resp112 = Resp124.fromJson(jsonDecode(snapshot.data));
                    ...
                    if (resp112.data.isNotEmpty) {
                      ...
                      for (var i = 0; i < resp112.data.length; i++) {
                        summa = summa +
                            (double.parse(resp112.data[0].purple
                        ...
                        children: [
                          ...
                          ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return SubButton(
                                title: resp112.data[index].datum,
                                count: resp112.data[index].empty,
                                sum: resp112.data[index].purple,
                              );
                            },
