...
class SumPage112 extends StatefulWidget {
  const SumPage112({Key key}) : super(key: key);

  @override
  _SumPageState createState() => _SumPageState();
}

class _SumPageState extends State<SumPage112> {
                    ...
                    children: [
                      ...
                      ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return SubButton(
                            title: resp112.data[index].empty,
                            count: '',
